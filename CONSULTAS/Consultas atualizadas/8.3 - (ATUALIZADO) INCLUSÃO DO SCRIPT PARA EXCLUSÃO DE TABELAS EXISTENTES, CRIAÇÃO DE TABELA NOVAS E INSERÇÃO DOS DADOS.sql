...
DROP VIEW RELATORIO_DURACAO_TRATAMENTO;
DROP VIEW RELATORIO_MEDIA_TRATAMENTO;
DROP VIEW RELATORIO_NUM_TRATAMENTO_HOSPITAL;
DROP VIEW RELATORIO_PESSOAS_MEDICAMENTO_POR_TRAT;
DROP VIEW RELATORIO_QUANT_TRATAMENTO;
DROP VIEW RELATORIO_TRAT_ANDAMENTO;
DROP VIEW RELATORIO_TRAT_FINALIZADO_HOSPITAL;
DROP VIEW RELATORIO_TRATAMENTO_FINALIZADO_HOSPITAL;
DROP VIEW RELATORIO_TRATAMENTO_MEDICO;
DROP VIEW RELATORIO_TRATAMENTO_POR_HOSPITAL;
...
ALTER TABLE HOSPITAL DROP CONSTRAINT HOSPITAL_UF_HOSPITAL_FKEY;
